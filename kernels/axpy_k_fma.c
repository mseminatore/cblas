...
//------------------------------------------------------
// single-precision axpy kernel incx == 1 && incy == 1 (FMA3)
// y = alpha * x + y
// Uses FMA instruction: y = fmadd(alpha, x, y)
//------------------------------------------------------
void cblas_saxpy_k_noinc_fma(cblas_args_t* args)
{
    ...
    // SSE cleanup for remaining 4+ elements (no FMA128, use mul+add)
...
//------------------------------------------------------
// double-precision axpy kernel incx == 1 && incy == 1 (FMA3)
// y = alpha * x + y
// Uses FMA instruction: y = fmadd(alpha, x, y)
//------------------------------------------------------
